...
tela()
{
    	# Função que imprime a arte ASCII na tela (só estética)
	echo -e "\033[01;31m
...
menu()
{
	...
	3)	links_externos;;
	4)	descobrir_email;;
	5) 	exit 0;;            # Sai do script
	*)	echo "Opcao Invalida" ;;   # Default
	esac
}
