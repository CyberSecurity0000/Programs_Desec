...
buscando_pag()
{
	# Cabeçalho visual para enumeração de páginas
	echo -e "\n\033[01;35m---------------------------------------------------------------------------------------------------------------------\033[00;00m"
	echo -e "|-> Buscando por Páginass"
...
tecnologia()
{
	...
	then
		...
		echo -e "\n\033[01;33m# WebServer Identificado: Sem informacão\033[00;00m"
	fi
...
listagem_extensao()
{
	...
	do
		...
		if [ "$status_code" -eq 200 ]
		then
			echo -e "\033[01;34mArquivo $4 encontrado: \033[00;00m\033[01;33m$1/$team.$4\033[00;00m"
		fi
...
then
	...
	echo -e "\n\033[01;31m# Usage: $0 <url> <wordlist> <extensao>\033[00;00m"
	echo -e "\n\033[01;32m# Exemplo 1: $0 http://businesscorp.com.br wordlist.txt \033[00;00m"
	echo -e "\n\033[01;33m# Exemplo 2: $0 http://businesscorp.com.br wordlist.txt -t php\033[00;00m"
