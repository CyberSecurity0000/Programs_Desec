...
# Função principal: Consultas DNS com o comando host
information()
{	
	# Banner
	buscando
	...
	# HINFO → info de hardware e sistema
...
# Verifica se o usuário passou 1 argumento ($# = quantidade de argumentos passados)
if [ $# -ne 1 ]
then
