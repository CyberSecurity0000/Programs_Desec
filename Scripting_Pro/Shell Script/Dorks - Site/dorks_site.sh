...
# Função visual para exibir mensagem de status
info()
{
        echo -e "\033[01;32m"
        echo -e "#########################################################"
...
then
	...
	# Chamada de funcção por passagem de parâmetro
	info $1
	...
	firefox "https://www.google.com.br/search?q=site:\"pastebin.com\"+\"$ALVO\""
	firefox "https://www.google.com.br/search?q=site:\"trello.com\"+\"$ALVO\""
	...
	# Termos que podem revelar documentos e dados pessoais públicos
