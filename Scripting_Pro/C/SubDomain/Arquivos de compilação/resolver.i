...
# 366 "/usr/include/x86_64-linux-gnu/bits/socket.h" 3 4
enum
  {
    SCM_RIGHTS = 0x01
# 378 "/usr/include/x86_64-linux-gnu/bits/socket.h" 3 4
  };
# 392 "/usr/include/x86_64-linux-gnu/bits/socket.h" 3 4
...
# 51 "resolver.c"
                 )
  {
   continue;
         ...
         char *ip = inet_ntoa(*(struct in_addr *)alvo->
# 57 "resolver.c" 3 4
                                                      h_addr_list[0]
# 57 "resolver.c"
                                                            );
